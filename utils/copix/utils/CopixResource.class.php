...
class CopixResource
{
     ...
     */
    private static function _checkI18N($basePath, $resDir, $resName, $useI18N, $lang, $country)
    {
        if(is_dir($basePath.".")) {
            if($useI18N) {
     ...
     */
    private static function _resolve($path, $moduleName, $modulePath, $theme, $useI18N, $lang, $country)
    {
        $resDir = dirname($path);
     ...
     * @return mixed Le chemin du fichier s'il a été trouvé, false sinon.
     */
    public static function findResourceURL($path, $moduleName=null, $modulePath=null, $theme=null, $useI18N=false, $lang=null, $country=null)
    {
        if($result = self::_resolve($path, $moduleName, $modulePath, $theme, $useI18N, $lang, $country)) {
            return $result[1];
        } else {
