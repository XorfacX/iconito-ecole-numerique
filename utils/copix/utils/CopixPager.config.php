...
$options['PARAMS'] = Array(
    ...
    'nextPage'        => '<img src="'._resource('img/pager-next.png').'" alt="next"/>&nbsp;',         // libellé lien vers la page suivante

    'previousPage'    => '<img src="'._resource('img/pager-previous.png').'" alt="previous"/>&nbsp;',       // libellé lien vers la page précédente

    'lastPage'        => '<img src="'._resource('img/pager-last.png').'" alt="last"/>',              // libellé lien vers la dernière page

    'firstPage'       => '<img src="'._resource('img/pager-first.png').'" alt="first"/>&nbsp;',              // libellé lien vers la première page
