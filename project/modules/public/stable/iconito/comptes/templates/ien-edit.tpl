<form method="POST">
	...
	<table class="editItems comptes_animateurs comptes_animateurs_edit">
		...
		<tr>
			<th class="form_libelle">Regroupements de villes<div class="help">Vous pouvez associer ce compte IEN &agrave; des regroupements de ville.</div></th>
		...
		<tr>
			<th class="form_libelle">Regroupements d'&eacute;coles<div class="help">Vous pouvez associer ce compte IEN &agrave; des regroupements d'&eacute;coles.</div></th>
			<td class="form_saisie">
		...
		<tr>
			<td></td>
			<td>
				<a class="button button-delete button-cancel" href="#delete_confirm" onclick="$('#delete_confirm').show();" class="no_button_like">Supprimer cet IEN</a>
