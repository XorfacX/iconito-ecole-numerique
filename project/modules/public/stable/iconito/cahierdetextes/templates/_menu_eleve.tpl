...
<ul>
  <li class="prev-week"><a href="{copixurl dest="cahierdetextes||voirTravaux" cahierId=$ppo->cahierId jour=$ppo->semainePrecedente|date_format:"%d" mois=$ppo->semainePrecedente|date_format:"%m" annee=$ppo->semainePrecedente|date_format:"%Y"}"><span class="valign"></span><span><img src="{copixurl}themes/default/img/action_back.png" alt="<" /></span></a></li>
  ...
  <li class="next-week"><a href="{copixurl dest="cahierdetextes||voirTravaux" cahierId=$ppo->cahierId jour=$ppo->semaineSuivante|date_format:"%d" mois=$ppo->semaineSuivante|date_format:"%m" annee=$ppo->semaineSuivante|date_format:"%Y"}"><span class="valign"></span><span><img src="{copixurl}themes/default/img/action_next.png" alt=">" /></span></a></li>
</ul>
</div>
</div>