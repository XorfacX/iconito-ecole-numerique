...
class Kernel
{
    ...
    public function getModEnabled($node_type, $node_id, $user_type = '', $user_id = 0, $full = 0, $notification = 0)
    {
        ...
        foreach ($list as $v) {
            if (!$full && $v->module_type == 'MOD_MAGICMAIL') {
                continue;
            }
    ...
    {
        if (Kernel::isDemo()) {
            return CopixActionGroup::process('genericTools|Messages::getError', array('message' => CopixI18N::get('kernel|kernel.error.nodemo'),
