...
<table border="0" CLASS="liste" ALIGN="CENTER" CELLSPACING=2 CELLPADDING=2>
 ...
 {foreach from=$liste item=r}
 	...
 	<tr CLASS="list_line{cycle values="0,1"}">
		...
		<img src="{copixresource path="themes/default/img/teleprocedures/puce_delai`$puce`.gif"}" alt="puce_delai{$puce}.gif" width="14" height="14" />
		</td>{/if}
    <td class="discret" align="center">{$r->dateinter|datei18n:"date_short"}</td>
	  ...
	  {else} {$r->datederniere|datei18n:"date_short"} {/if}</td>
		...
		<td>{if $r->last_visite eq null or $r->last_visite<$r->datederniere}<img src="{copixresource path="themes/default/img/icon_new.gif"}" alt="icon_new.gif" width="17" height="17" border="0" align="right" />{/if}<a title="Fiche" href="{copixurl dest="|fiche" id=$r->idinter}">{$r->objet|escape}</a></td>	 
...
{if $canViewDelai}
<img src="{copixresource path="themes/default/img/teleprocedures/puce_delai1.gif"}" alt="puce_delai0.gif" width="14" height="14" /> d&eacute;lai inf&eacute;rieur &agrave; 2 jours | <img src="{copixresource path="themes/default/img/teleprocedures/puce_delai2.gif"}" alt="puce_delai2.gif" width="14" height="14" /> d&eacute;lai entre 3 et 5 jours | <img src="{copixresource path="themes/default/img/teleprocedures/puce_delai3.gif"}" alt="puce_delai3.gif" width="14" height="14" /> d&eacute;lai sup&eacute;rieur &agrave; 5 jours | <img src="{copixresource path="themes/default/img/teleprocedures/puce_delai0.gif"}" alt="puce_delai0.gif" width="14" height="14" /> proc&eacute;dure close | 
{/if}

<img src="{copixresource path="themes/default/img/icon_new.gif"}" alt="icon_new.gif" width="14" height="14" border="0" /> du neuf &agrave; lire
