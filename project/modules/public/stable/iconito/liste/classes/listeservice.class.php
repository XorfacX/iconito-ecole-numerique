...
{
    /**
     * Ajoute un message � une liste, et s'occupe de l'envoyer � tous ses membres en minimail
     *
     ...
     *
     * Teste si l'usager peut effectuer une certaine op�ration par rapport � son droit. Le droit sur la liste n�cessite d'�tre connu, renvoy� par le kernel avant l'entr�e dans cette fonction.
     *
     * @author Christophe Beyer <cbeyer@cap-tic.fr>
     * @since 2006/03/30
